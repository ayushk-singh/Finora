...
export const DesktopSidebar = ({
  ...
  return (
    <motion.div
      className={cn(
        "h-full px-4 py-4 hidden md:flex md:flex-col bg-muted border-r border-border w-[300px] shrink-0",
        className
      )}
      animate={{
...
export const SidebarLink = ({
  ...
  return (
    <a
      ...
      onClick={handleClick}
      className={cn(
        "flex items-center justify-start gap-2 group/sidebar py-2 transition-colors hover:text-primary",
        className
      )}
      {...props}
    >
